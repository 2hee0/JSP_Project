        ...
        <div class="cs-table-a">
            <table class="cs-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <p class="noti-date">서비스 공지</p>
                        </td>
                        <td>
                            <p class="noti-title">
                                [점검안내]9월 5일 SBS(ch.6) 라이브 채널 점검
                            </p>
                        </td>
                        <td>
            ...
            <div class="noti-detail">
                <textarea class="contenttext" name="content" id="content"></textarea>
            </div>
            <div class="noti-btn-wrap">
                <div class="noti-d-btn">
                    <a href="#">
                        <span class="noti-d-text">이전글</span>
                        <strong class="noti-d-tit">[업데이트] 8월 5주 프로그램 리스트</strong>
                        <span class="noti-d-date">2023-09-01</span>
                    </a>
                </div>
                <div class="noti-d-btn">
                    <a href="#">
                        <span class="noti-d-text">다음글</span>
                        <strong class="noti-d-tit">[점검안내] 9월 2일 MBN,MBn+라이브 채널 점검</strong>
                        <span class="noti-d-date">2023-09-01</span>
                    </a>
                </div>
            </div>
