		...
		<div class="cs-table-a">
			<table class="cs-table">
				...
				<tbody>
					<tr>
						<td>
							<p class="noti-nick">${board.user_nick}</p>
						</td>
						<td>
							<p class="noti-title">${board.boardtitle}</p>
						</td>
						<td>
			...
			<div class="noti-detail">
				<textarea class="contenttext" name="content" id="content" readonly>
                ${board.boardcontent }
                </textarea>
			</div>
			<div class="btn-list">
				...
				</a> <a href="${pageContext.request.contextPath}/BoardList.mo">
