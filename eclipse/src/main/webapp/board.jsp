				...
				<div class="cs-table01-wrap">
					...
					<table class="cs-table-02">
						...
						<tbody>
							<tr class="noti">
								...
								<td><a href="../boardview.html"><span class="noti-content">[점검안내]
											바꾸자</span></a><span class="badge ui">NEW</span></td>
								<td>
							...
							<tr class="noti">
								...
								<td><a href="../boardview.html"><span class="noti-content">[업데이트]
											바꾸자</span></a>
								<!----></td>
								<td>
					...
					<div class="paging-type02">
						...
						<a href="#" class="on">1</a><a href="#" class="">2</a><a href="#"
							...
							href="#" class="">6</a><a href="#" class="">7</a><a href="#"
							class="">8</a><a href="#" class="">9</a><a href="#" class="">10</a><a
							id="next-page" href="#" class="arrow"> <img
							src="../img/right-arrow.png" alt="다음 10개 페이지"></a>
					</div>
				</div>
			</hgroup>
		</div>
			...
			<div class="footer-box-inner">
				...
				<div class="gongi-list-line">
					<ul class="gongi-list"
						...
						<li class="gongili" data-swiper-slide-index="2"><a href="#"
							title="공지사항" class="gongia" data-notice-index="2">공지사항1</a></li>
						<li class="gongili" data-swiper-slide-index="2"><a href="#"
							title="공지사항" class="gongia" data-notice-index="2">공지사항2</a></li>
						<li class="gongili" data-swiper-slide-index="2"><a href="#"
							title="공지사항" class="gongia" data-notice-index="2">공지사항3</a></li>
						<li class="gongili" data-swiper-slide-index="2"><a href="#"
							title="공지사항" class="gongia" data-notice-index="2">공지사항4</a></li>
						<li class="gongili" data-swiper-slide-index="2"><a href="#"
							title="공지사항" class="gongia" data-notice-index="2">공지사항5</a></li>
					</ul>
				</div>
			</div>
		</div>
