    ...
    <main class="main">
        <div class="page-top">
            <hgroup class="page-top-inner-wrap">
                    ...
                    <div class="cs-table01-wrap">
                        ...
                        <table class="cs-table-02">
                            ...
                            <tbody>
                                <tr class="noti">
                                    <td>
                                        <p class="noti-type">서비스공지</p>
                                    </td>
                                    <td><a href="boardview.jsp"><span class="noti-content">[점검안내] 9월 5일 SBS(ch.6) 라이브 채널 점검</span></a><span
                                            class="badge ui">NEW</span></td>
                                    <td>
                                        <p class="noti-date">2023-09-04</p>
                                    </td>
                                </tr>
                                <tr class="noti">
                                    <td>
                                        <p class="noti-type">콘텐츠공지</p>
                                    </td>
                                    <td><a href="boardview.jsp"><span class="noti-content">[업데이트] 8월 5주 프로그램 리스트</span></a><!----></td>
                                    <td>
                                        <p class="noti-date">2023-09-01</p>
                                    </td>
                                </tr>
                                <tr class="noti">
                                    <td>
                                    ...
                                    <td><a href="boardview.jsp"><span class="noti-content">[점검안내] 9월 2일 MBN,MBN+라이브 채널 점검</span></a><!----></td>
                                    <td>
                                        <p class="noti-date">2023-09-01</p>
                                    </td>
                                </tr>
                        ...
                        <div class="cs-table02-wrap">
                            ...
                            <table class="cs-table-02">
                                ...
                                <tbody>
                                    <tr class="noti">
                                        <td>
                                            <p class="noti-type">닉네임1</p>
                                        </td>
                                        <td><a href="#"><span class="noti-content"> 4조 ㅎㅎㅎㅎㅎㅎ팀 JSP프로젝트 </span></a><span
                                                class="badge ui"></span></td>
                                        <td>
                                            <p class="noti-date">2023-09-07</p>
                                        </td>
                                        <td>
                                            <p class="view-count">985</p>
                                        </td>
                                    </tr>
                                    <tr class="noti">
                                        <td>
                                        ...
                                        <td><a href="#"><span class="noti-content"></span></a><!----></td>
                                        <td>
                                            <p class="noti-date"></p>
                                        </td>
                                        <td>
                ...
                <div class="paging-type02"><!----><a href="#" class="on">1</a><a href="#" class="">2</a><a href="#"
                            class="">3</a><a href="#" class="">4</a><a href="#" class="">5</a><a href="#"
                            class="">6</a><a href="#" class="">7</a><a href="#" class="">8</a><a href="#"
                            class="">9</a><a href="#" class="">10</a><a id="next-page" href="#" class="arrow">
                            <img src="./img/right-arrow.png" alt="다음 10개 페이지"></a></div>
                </div>
            </hgroup>
        </div>
        </main>
