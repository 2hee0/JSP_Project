		...
		<div class="member">
			<div class="join member-layout" id="g-contents">
				...
				<div class="common-box">
					...
					<form action="${pageContext.request.contextPath}/signup/complete.mo" autocomplete="off" id="myFrm" method="post" name="myFrm"
						...
						<fieldset>
							...
							<ul class="join-input-box">
								...
								<li>
									<label for="user_name">
										이름 : <input type="text" name="user_name" placeholder="이름 정자로 입력해주세요"
							...
							<ul class="btn-wavve-join" id="sub-join-submit">
								<li><a href="javascript:document.myFrm.submit();" onclick="onCheckSignIn();">GIIGLE 회원가입</a></li>
							</ul>
						</fieldset>
					</form>
				</div>
