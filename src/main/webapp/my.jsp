		...
		<div class="header-main">
			...
			<nav class="menu1">
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/mylogin.mo">MY</a>
					</li>
				</ul>
			</nav>
		</div>
