                    ...
                    <li>
                        <a href="event1.jsp">
                            ...
                            <div class="event-img">
                                <div class="img-area">
                                    <picture>
                                        <source srcset="./img/event-thumb.png" type="image/png">
                                        <img src="./img/event-thumb.png" alt="[영화 제목] 프로모션">
                                    </picture>
                                </div>
                            </div>
                            <span class="img-text">
                                <strong class="event-title">
                                    <인디아나존스 : 운명의 다이얼> 론칭 프로모션
                                </strong>
                                <span class="event-tr">
                                    <strongc class="event-th">기간</strongc>
                                    <span class="event-td">2023-09-01 ~ 2023-09-30</span>
                                </span>
                                <span class="event-tr">
                    ...
                    <li>
                        <a href="event2.jsp">
                            <div class="event-img">
                                <div class="img-area">
                                    <picture>
                                        <source srcset="img/event-thumb2.png" type="image/png">
                                        <img src="./img/event-thumb2.png" alt="[영화 제목] 프로모션">
                                    </picture>
                                </div>
                            </div>
                            <span class="img-text">
